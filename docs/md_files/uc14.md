# UC14 AI Resources, Demand & Line Analytics

## Purpose
Document the use case UC14 in the $pillar pillar.

## Description
Predictive ML that converts operational data from lines, plants and warehouses into forward-looking insight, anticipating maintenance needs and spare-parts demand, keeping stock at optimum levels.
...
## Business Impact
Optimum stock levels without over- or under-stocking; higher crew and asset utilization.
