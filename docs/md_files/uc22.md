# UC22 Finance Invoice & Budget Control

## Purpose
Document the use case UC22 in the $pillar pillar.

## Description
Reads invoices from purchase orders, maintenance and suppliers together with budget lines and approval chains, flagging exceptions, duplicates and budget impact before processing.
...
## Business Impact
Faster finance review; fewer manual checks; clearer spend visibility across plants.
