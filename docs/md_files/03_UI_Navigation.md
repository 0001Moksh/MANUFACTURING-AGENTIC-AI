...
## Purpose
Document the navigation hierarchy and page relationships in the walkthrough.
...
- Use-Case Library
  ...
  - Type filters
  - Search
  - Use-case modal details
- AI Agents
  - 12 specialized agents
  - Per-agent enablement toggle
- Admin Console
  - Users & Roles
  - Sites & Plants
  - Integrations
...
## Relationships
- Page behavior is linked to [19_Page_Map](./19_Page_Map.md).
- The side navigation and persona controls are part of [05_Dashboard_Overview](./05_Dashboard_Overview.md).
