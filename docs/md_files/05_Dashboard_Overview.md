...
## Purpose
Document the live dashboard simulation and the business meaning of each widget.

## Description
The dashboard is a command-centre view intended for manufacturing and digital leaders. It combines operational KPIs, a live feed, and an executive summary.

## Widgets
| Widget | Meaning | Decision Supported |
|---|---|---|
| Production Output | Throughput versus plan | Production balancing |
| Plant OEE (avg) | Availability, performance, quality composite | Efficiency improvements |
| Zero Harm Index | Safety performance indicator | HSE prioritization |
| Revenue YTD | Financial result against target | Commercial review |
| Live Agent Activity | Streaming agent events | Immediate response |
| AI Executive Summary | Prioritized action list | Leadership attention |

## Relationships
- KPI definitions are documented in [06_KPI_Reference](./06_KPI_Reference.md).
- Agent behavior is documented in [07_AI_Agents](./07_AI_Agents.md).
