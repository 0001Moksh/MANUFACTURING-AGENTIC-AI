# UC6 Chat with Data: Executive Insights

## Purpose
Document the use case UC06 in the $pillar pillar.

## Description
A chat experience over enterprise data that lets leadership ask for any report in natural language and receive an instant answer, visualized as charts with a short narrative summary.
...
## Business Impact
Management self-serves insights in seconds; one governed source of truth behind every number.
