...
## Purpose
Explain the platform's value tracking and adoption reporting.

## Metrics
- Use-case adoption by plant
- Agent uptime
- Cumulative ROI
- Time-to-value
...
## Business Meaning
The analytics page is meant to support board-level and CFO-level discussions by showing that adoption is growing and value is compounding.

## Relationships
- The adoption bar chart is described in [05_Dashboard_Overview](./05_Dashboard_Overview.md).
- ROI terms are defined in [13_Business_Value](./13_Business_Value.md).
