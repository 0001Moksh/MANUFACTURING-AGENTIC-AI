...
## Purpose
List the major pages and what each one contains.

## Pages
- iew-overview: command-centre dashboard
- iew-usecases: use-case library
- iew-agents: specialized AI agents
- iew-admin: admin console
- iew-analytics: analytics and ROI
- iew-settings: platform settings

## Relationships
- Navigation switching is handled by the sidebar in the source HTML.
