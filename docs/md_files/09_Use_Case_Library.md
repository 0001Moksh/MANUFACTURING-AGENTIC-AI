...
## Purpose
Document the 23 deployable modules shown in the simulation and how they map to the five strategic pillars.

## Description
The library groups the product into operational excellence, sustainable operations, smart growth, financial resilience, and horizontal enterprise capabilities. Each use case can be filtered by pillar or by capability type.

## Strategic Pillars
| Pillar | Use Cases |
|---|---|
| Operational Excellence | 1-8 |
| Sustainable Operations | 9-12 |
| Smart Growth & Expansion | 13-15 |
| Financial Resilience | 16-19 |
| Horizontal Enterprise | 20-23 |
...
- Search field
- Use-case cards
- Detail modal with admin controls and approval settings

## Relationships
- Individual use cases are documented as uc01.md through uc23.md.
- The modal configuration behavior is explained in [10_Admin_Console](./10_Admin_Console.md).
