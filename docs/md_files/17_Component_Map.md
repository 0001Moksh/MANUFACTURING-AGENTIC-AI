...
## Purpose
Map the major product components shown in the walkthrough.

## Components
- Frontend shell
- Sidebar navigation
- Topbar with persona toggle and clock
- Overview dashboard
- Use-case library
- Agent gallery
- Admin console
...
## Notes
This map focuses on visible product components rather than code files.
