...
## Purpose
Define the recurring terms used throughout the documentation.
...
| Vision AI | Computer vision applied to industrial video streams |
| Incident Investigation | Workflow for analyzing safety or operational events |
| Root Cause Analysis | Structured analysis to identify underlying causes |
| Safety Score | Composite indicator of safety performance |
| Revenue Metrics | Business measures tied to sales or output value |
