# UC20 AI Technical Support Desk

## Purpose
Document the use case UC20 in the $pillar pillar.

## Description
Voice and chat agents answer technical support calls from plants, lines and offices around the clock, auto-triage the issue, resolve known problems, and dispatch field teams with context already attached.
...
## Business Impact
Support coverage around the clock; faster resolution; lower first-line support burden.
