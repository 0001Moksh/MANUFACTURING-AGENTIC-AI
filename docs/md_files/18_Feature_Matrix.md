...
## Purpose
Summarize which capabilities the platform provides across the simulation.

## Matrix
| Feature | Status | Area |
|---|---|---|
| Conversational reporting | Live | Operations |
| Voice interaction | Live | Operations |
| SOP and manual assistant | Live | Operations |
| Document extraction | Live | Operations |
| Computer vision safety | Live | HSE |
| Wearable monitoring | Pilot | HSE |
| Asset tracking | Live | Operations |
| Production orchestration | Pilot | Planning |
| Supply chain intelligence | Pilot | Finance / Risk |
| Technical support desk | Live | Horizontal |
| Finance controls | Live | Horizontal |
| Procurement evaluation | Pilot | Horizontal |
