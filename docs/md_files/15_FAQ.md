...
## Purpose
Capture common questions implied by the simulation.

## Questions
### Is this a live production system?
No. The footer explicitly states that the walkthrough is a simulated internal sales-enablement environment.

### Does the platform require new hardware?
Not necessarily. The source highlights reuse of existing cameras, sensors, and enterprise systems.

### Can it run offline?
Yes for some sites. One site entry explicitly references edge-only, offline-capable operation.

### Is the platform configurable per plant?
Yes. Roles, agents, rules, notifications, retention, and deployments are all presented as plant-scoped or configurable.
