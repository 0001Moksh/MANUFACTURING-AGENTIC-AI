# UC23 Procurement Sourcing & Vendor Evaluation

## Purpose
Document the use case UC23 in the $pillar pillar.

## Description
Supports sourcing requests for spare parts and services: drafting request documents, comparing vendor responses against evaluation criteria side by side, and tracking clarifications through to closure.
...
## Business Impact
Shorter sourcing cycles; more consistent evaluation; stronger procurement governance.
