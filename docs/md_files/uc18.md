# UC18 OT / ICS Cyber-Anomaly Detection

## Purpose
Document the use case UC18 in the $pillar pillar.

## Description
Protects the digital systems every plant depends on. The system learns what normal looks like for each machine's control network and raises an alert the moment behavior turns abnormal.
...
## Business Impact
Cyber interference caught early, before it endangers production or safety.
