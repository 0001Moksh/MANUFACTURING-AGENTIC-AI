# UC21 HR Candidate Profile Assessment

## Purpose
Document the use case UC21 in the $pillar pillar.

## Description
Assesses resumes and candidate profiles against role requirements, skills and structured criteria, producing a ranked shortlist with reasoning attached for recruiter review, for shop-floor and shore roles alike.

## Features
- Status: Pilot
- Tags: ML, GENAI
- Pillar: Horizontal Enterprise
...
## Business Impact
Faster shortlist cycles for a large workforce; consistent screening; better candidate quality.
