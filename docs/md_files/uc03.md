# UC3 Knowledge Assistant: Manuals & SOPs

## Purpose
Document the use case UC03 in the $pillar pillar.

## Description
A generative-AI assistant that lets the workforce ask about equipment, manuals, processes or SOPs in natural language and get an immediate, cited answer without searching documents.
...
## Business Impact
Technical answers in seconds; faster onboarding; fewer errors from outdated procedures.
