# UC13 Agentic Production Orchestration

## Purpose
Document the use case UC13 in the $pillar pillar.

## Description
An agentic layer on top of existing production-planning systems that plans line schedules and resolves exceptions across every plant and distribution point, replanning in minutes when disruption hits.

## Features
- Status: Pilot
- Tags: AGENTIC, ML
- Pillar: Smart Growth & Expansion
...
## Business Impact
Higher line utilization; disruptions recovered in minutes instead of hours of manual coordination.
