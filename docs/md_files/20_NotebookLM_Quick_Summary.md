...
## Agent Summary
The platform includes 12 named agents plus specialized embedded assistants across 23 use cases.

## Terminology
Refer to [14_Glossary](./14_Glossary.md) for recurring manufacturing, governance, and AI terms.
