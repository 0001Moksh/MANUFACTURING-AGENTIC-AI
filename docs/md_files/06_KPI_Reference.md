...
## Purpose
Define the metrics surfaced in the simulation and the analytics section.

## KPI Catalog
| KPI | Description | Where It Appears |
|---|---|---|
| Production Output | Daily throughput in tonnes per day | Overview |
| Plant OEE | Aggregate equipment effectiveness | Overview, Analytics |
| Zero Harm Index | Composite safety score | Overview |
| Revenue YTD | Year-to-date revenue | Overview |
| Agent Uptime | Rolling uptime across agents | Analytics |
| Cumulative ROI | Return generated per plant | Analytics |
| Avg. Time-to-Value | Time to activate a new use case | Analytics |
| Alert-to-Action | Time from signal to notification | Analytics |

## Notes
Some KPI names are business-facing and may map to multiple system metrics in implementation.
