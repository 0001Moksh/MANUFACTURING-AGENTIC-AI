...
## Flow
1. Signals originate in ERP, MES, CCTV, IoT, EHS, and communication systems.
2. The platform ingests and normalizes data.
3. Agents and rules evaluate the data for anomalies, forecasts, or recommendations.
4. Notifications and work orders are emitted to the appropriate channels and systems.
5. Analytics aggregate usage and value over time.

## Relationships
- Connector details are in [10_Admin_Console](./10_Admin_Console.md).
- Notification channels are in [12_Settings](./12_Settings.md).
