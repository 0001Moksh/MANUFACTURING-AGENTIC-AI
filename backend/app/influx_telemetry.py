...
METRIC_CONFIG = {
    "temperature": {
        ...
        "bucket": os.getenv("INFLUX_TEMPERATURE_BUCKET", os.getenv("INFLUXDB_BUCKET", "Test")),
        "normal": [0, 75],
        "warning": 85,
        "critical": 98,
    },
    "vibration": {
        ...
        "bucket": os.getenv("INFLUX_VIBRATION_BUCKET", os.getenv("INFLUXDB_BUCKET", "Test")),
        "normal": [0, 3.5],
        "warning": 5,
        "critical": 7.5,
    },
    "current": {
        ...
        "bucket": os.getenv("INFLUX_CURRENT_BUCKET", os.getenv("INFLUXDB_BUCKET", "Test")),
        "normal": [0, 160],
        "warning": 185,
        "critical": 210,
    },
    "power": {
        ...
        "bucket": os.getenv("INFLUX_POWER_BUCKET", os.getenv("INFLUXDB_BUCKET", "Test")),
        "normal": [0, 2500],
        "warning": 2650,
        "critical": 2780,
    },
    "rpm": {
        ...
        "bucket": os.getenv("INFLUX_RPM_BUCKET", os.getenv("INFLUXDB_BUCKET", "Test")),
        "normal": [0, 18],
        "warning": 18.8,
        "critical": 19.5,
    },
