          ...
          {Array.from(resourceRanges.values()).map((r) => {
            ...
            return (
              <div
                ...
                className="group absolute flex items-center justify-between gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[11.5px] font-semibold text-slate-700 shadow-sm dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
  ...
  return (
    <div className="mt-6 space-y-5">
      ...
      {groupedRules.length === 0 ? (
        <div className="rounded-xl border-2 border-dashed border-slate-200 dark:border-slate-800 p-8 text-center">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          {groupedRules.map(([moduleKey, group]) => {
            ...
            return (
              <div
                key={moduleKey}
                className="group rounded-xl border border-slate-200 bg-slate-50/50 p-4 shadow-sm transition-all hover:border-indigo-500/40 hover:shadow-md dark:border-slate-800 dark:bg-slate-900/50"
              >
                {/* Module Header Row */}
                <div className="mb-3 flex items-center justify-between gap-2">
                  <div className="flex min-w-0 items-center gap-2.5">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-0.5 inline-flex items-center gap-1 rounded-full bg-indigo-500/10 px-2 py-0.5 text-[10px] font-bold text-indigo-600 dark:text-indigo-400">
                  ...
                  <div className="flex shrink-0 items-center gap-1 opacity-70 transition-opacity group-hover:opacity-100">
                    <button
                      ...
                      className="rounded-md border border-red-200 bg-red-50 p-1.5 text-red-600 hover:bg-red-100 dark:border-red-900/40 dark:bg-red-950/30"
                    >
                  ...
                  {group.rows.map((rule) => {
                    ...
                    return (
                      <div
                        ...
                        className="flex flex-wrap items-start justify-between gap-2 rounded-lg bg-white/60 p-2.5 dark:bg-slate-950/30"
                      >
                        <div className="flex flex-1 flex-wrap items-center gap-2 min-w-0">
                          ...
                          {isBulk ? (
                            ...
                            <span className="inline-flex items-center rounded-md border border-slate-200 bg-slate-100 px-2.5 py-1 text-[11px] font-medium text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
                              {rule.resource_label}
                            </span>
                          )}
                        ...
                        <div className="flex shrink-0 items-center gap-1">
                          <button
                            ...
                            className="rounded-md border border-slate-200 bg-white p-1.5 text-slate-500 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-400"
                          >
