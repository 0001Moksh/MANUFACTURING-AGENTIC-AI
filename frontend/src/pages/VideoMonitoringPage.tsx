...
const INITIAL_CHARTS: ChartDefinition[] = [
  {
    ...
    description: 'Daily violation breakdown by type',
  ...
  },
  {
    ...
    description: 'Critical, warning, and normal alerts',
    colSpan: 'col-span-1',
    isVisible: true,
  },
  {
    ...
    category: 'Histogram',
    description: 'Alert volume by hour',
    colSpan: 'xl:col-span-2',
    isVisible: true,
  },
  {
    ...
    category: 'Per-Device',
    description: 'Violations by camera',
    colSpan: 'col-span-1',
    isVisible: true,
  },
  {
    ...
    description: 'Risk activity across plant zones',
  ...
  },
  {
    ...
    category: 'Bar Chart',
    description: 'Daily detection volume',
    colSpan: 'col-span-1',
    isVisible: true,
  },
  {
    id: 'violation_ranking',
    name: 'Violation Ranking',
    category: 'Frequency',
    description: 'Top violation types',
    colSpan: 'col-span-1',
    isVisible: true,
  },
  {
    ...
    category: 'Scoring',
    description: 'Risk score by camera',
    colSpan: 'col-span-1',
    isVisible: true,
  },
  {
    ...
    description: 'Highest-risk zones',
    colSpan: 'col-span-1',
    isVisible: true,
  },
];
